/// @description Game events
	...
	if(global.bonus_stage_state == BONUSSTAGE.GOING_TO || global.bonus_stage_state == BONUSSTAGE.LEAVING)
	{
		if(!bonus_stage_trigger)
		{
			...
			if(global.bonus_stage_state == BONUSSTAGE.GOING_TO) global.previous_room = room;
		...
		else 
		{
			...
			{
				room_goto(global.bonus_stage_state == BONUSSTAGE.GOING_TO ? global.bonus_list[global.bonus_stage_type] : global.previous_room);
